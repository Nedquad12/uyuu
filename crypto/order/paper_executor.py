...
# ------------------------------------------------------------------
# Tracking modal — potong margin saat open, kembalikan saat close
# ------------------------------------------------------------------
...
def execute_paper_order(ai_result: dict, pred: dict, notify_fn=None) -> dict:
    ...
    # ── Hitung virtual sizing pakai saldo tersedia ────────────────
    ...
    # Guard: margin tidak boleh melebihi saldo tersedia
