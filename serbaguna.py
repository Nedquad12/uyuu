...
@queued_handler
@cooldown(seconds=5)
def holdings_summary_fixed(message):
    ...
    try:
        ...
        # Gabungkan kepemilikan dengan harga penutupan
        df = df.merge(price_df, on='Code', how='left')
        df.dropna(subset=['Penutupan'], inplace=True)  # Hapus jika tidak ada harga
