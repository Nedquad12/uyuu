...
class TelegramStockDataViewer:
    def __init__(self, data_folder=None):
        ...
        self.chart_folder = "/home/nedquad12/uyuu/foreign"
...
def foreign_flow_table(message):
    if message.chat.type == 'private' and message.from_user.id not in WHITELIST_USER_IDS:
        bot.send_message(
            message.chat.id,
            "Hi!! Maaf bot tidak bisa diakses, untuk akses gratis bisa masuk ke grup https://t.me/botmsaham. Jika ingin tanpa delay bisa hubungi @Rendanggedang"
        )
        return
