...
class TradingIndicator:
    ...
    def calculate_moving_averages(self, data, timeframe):
        ...
        if timeframe == 'Daily':
           ...
           return ma5, ma20, ma60, ma90, ma120, ma200
    ...
    def calculate_final_formula(self, data, timeframe):
        ...
        final_score = (m_gt_s*1.5 + mup + sup + ku1 + ku2 + ku3 + msdu - 
                      kd1 - kd2 - kd3 - mdn - sdn - m_lt_s*1.5 - msdn) 
...
async def cmd_calculate(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
     ...
     # Auto-add .JK for Indonesian stocks if not already present
        ...
        timeframes = {
            'Daily': {'period': '1d', 'days': 40, 'download_days' : 500},
            'Weekly': {'period': '1wk', 'days': 10*7, 'download_days' : 60*7},  # 40 minggu
