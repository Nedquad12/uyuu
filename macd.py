...
class TradingIndicator:
    ...
    def calculate_price_changes(self, data, atr_period=14, atr_multiplier=1.5, point_boost=1.3):
    ...
    def calculate_final_formula(self, data, timeframe):
        ...
        final_score = (m_gt_s + mup*1.2 + sup + ku1 + ku2 + ku3 + msdu - 
                      kd1 - kd2 - kd3 - mdn*1.2 - sdn - m_lt_s - msdn) 
