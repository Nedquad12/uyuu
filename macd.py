...
class TradingIndicator:
    ...
    def calculate_m_value(self, data, macd_line, signal_line, histogram, period=14, multiplier=1.5):
    ...
    # Hitung ATR
        atr = true_range.rolling(window=period).mean()  # bisa diganti EMA jika mau lebih smooth
    ...
    def calculate_final_formula(self, data, timeframe):
        ...
        m_values = self.calculate_m_value (data, macd_line, signal_line, histogram, period=14, multiplier=1.5)
