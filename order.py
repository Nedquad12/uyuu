...
class TradingAnalyzer:
    def __init__(self):
        ...
        self.data_folder = r"/home/ec2-user"
    ...
    def load_stock_data(self, stock_code, user_id):
        ...
        # Hapus cache user saat memuat saham baru
        if user_key in self.user_cache:
            del self.user_cache[user_key]
    
        # Check cache first (bagian ini akan dilewati karena cache dihapus)
...
def main():
    ...
    application = Application.builder().token("7711952258:AAFR63V5E_k1ApKEZBjE3Ine5QYfj7xW9MY").build()
