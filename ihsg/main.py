...
from saham_command import register_saham_handler   # ← BARU
...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "  `/saham BBCA` — analisis lengkap saham\n"
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "`/saham XXXX` — analisis lengkap (volume, foreign, MA, margin, holdings, sektor)\n"
        "`/ex XXXX` — pie chart kepemilikan Lokal & Asing\n"
        "`/xlsx XXXX` — unduh Excel kepemilikan\n"
        "contoh: `/skor BBCA` · `/saham BBCA` · `/ex BBCA`",
        parse_mode=ParseMode.MARKDOWN,
    )
...
def main():
    ...
    register_saham_handler(app)                        # ← BARU: /saham
