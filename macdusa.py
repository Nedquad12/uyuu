...
class TradingIndicator:
    ...
    def calculate_m_value_combined(self, data, macd_line, signal_line, period=14, atr_multiplier=1.0):
    ...
    # Hitung StdDev dari signal_line
        ...
        # Oversold area (0–25)
                ...
                if oversold_days == 1:
                    sup.append(0)
                    sdn.append(-1)  # Hari pertama oversold
                elif oversold_days == 2:
                    sup.append(0)
                    sdn.append(0)   # Hari kedua oversold
                else:
                    sup.append(0)
                    sdn.append(1)   # Hari ketiga oversold
        ...
        # Overbought area (75–100)
                ...
                if overbought_days <= 2:
                    sup.append(0)  # Hari pertama & kedua overbought
                    sdn.append(0)
                else:
                   sup.append(-1) # Hari ketiga overbought
                   sdn.append(-1)
                ...
                oversold_days = 0
                if overbought_days == 1:
                    sup.append(-1)  # Hari pertama >90
                    sdn.append(-1)
                else:
                    sup.append(-2)  # Hari kedua >90
                    sdn.append(-2)
            else:
                sup.append(0)
                sdn.append(0)
    ...
    def calculate_final_formula(self, data, timeframe):
        ...
        m_values = self.calculate_m_value_combined(data, macd_line, signal_line, period=14, atr_multiplier=1.0)
        ...
        final_score = (m_gt_s + mup*1.1 + sup*1.1 + ku1 + ku2 + ku3 + msdu - 
                      kd1 - kd2 - kd3 - mdn*1.1 - sdn*1.1 - m_lt_s - msdn)
...
# Hitung average score setelah semua timeframe diproses
          ...
          interpretation = ""
          if average_score > 3.9:
             interpretation = "🟢 STRONG BUY"
          elif average_score > 2.4:
             interpretation = "🔵 BUY"
