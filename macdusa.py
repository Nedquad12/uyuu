...
BOT_TOKEN = "7832471843:AAE2MggR5Hqnm38oX7IcUtEx6vTOGIOudUg"
...
class TradingIndicator:
    ...
    def calculate_m_value_combined(self, data, macd_line, signal_line, period=14, atr_multiplier=1.2, std_multiplier=1.5):
    ...
    def calculate_final_formula(self, data, timeframe):
        ...
        m_values = self.calculate_m_value_combined(data, macd_line, signal_line, period=14, atr_multiplier=1.2, std_multiplier=1.5)
...
def main():
    ...
    # Tambahkan handler
    app.add_handler(CommandHandler("us", cmd_calculate))
