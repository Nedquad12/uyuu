...
BOT_TOKEN = "7832471843:AAH4nqrF9TThZV0Xugf47QJUk6Hx8tzEY9A"
...
class TradingIndicator:
    ...
    def calculate_final_formula(self, data, timeframe):
        ...
        final_score = (m_gt_s + mup + sup + ku1 + ku2 + 0.5*ku3 - 
                      kd1 - kd2 - 0.5*kd3 - mdn - sdn - m_lt_s - msdn)
...
async def cmd_calculate(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        timeframes = {
            ...
            'Weekly': {'period': '1wk', 'days': 18*7, 'download_days' : 60*7},  # 40 minggu
        ...
        for tf_name, tf_config in timeframes.items():
            try:
                ...
                if tf_name == 'Daily':
                    ...
                    display_days = 18*7    # 5 minggu untuk display
                else:  # Monthly
