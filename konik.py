...
class TelegramStockDataViewer:
    ...
    def get_data_info(self):
        ...
        if self.margin_df is None:
            ...
            margin_info = {
                'total_mr': margin_records,
                'unique_mc': margin_codes,
                'date_mr': margin_range
            }
...
Available commands for Blackrock Holding
/bi for Indonesia stock
/bc for China stock
/btc for Bitcoin
/bu for US stock (S&P500)
/b7 - Significant movements

Usage Examples:
- /search BBCA - Search for BBCA stock
- /bi BBCA -Search for BBCA stock owned by Blackrock
...
📈 Unique stocks: {regular['unique_codes']}
📅 Date range: {regular['date_range']}"""
